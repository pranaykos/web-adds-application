...
@MatchField(firstFieldName = "password", secondFieldName = "confirmPassword", message = "Password and Confirm password should be same")
public class ApplicationClient {
	...
	@Size(min = 1, message = "Official address is required")
	...
	public String toString() {
		return "ApplicationClient [id=" + id + ", email=" + email + ", companyName=" + companyName + ", username="
				+ username + ", password=" + password + ", confirmPassword=" + confirmPassword + ", address=" + address
				+ ", role=" + role + "]";
	}
