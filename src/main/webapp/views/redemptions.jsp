			...
			<div class="col-md-8 offset-md-2">
					...
					<c:choose>
						<c:when test="${length == 0}">
							<h1 class="display-4">No redemption
								requests yet ...</h1>
						</c:when>
					<c:otherwise>
										...
										<c:choose>
											<c:when test="${redemption.isAccepted == 1}">
												<td><span style="font-size: 1em"
													class="badge badge-success badge-pill">Accepted</span></td>
											</c:when>
											<c:otherwise>
												<td><span style="font-size: 1em"
													class="badge badge-warning badge-pill">Pending</span></td>
											</c:otherwise>
										</c:choose>
									</tr>
								</c:forEach>
